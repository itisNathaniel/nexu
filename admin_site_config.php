...
<form method="post" class="form-horizontal">
	...
	<div class="form-group">
		...
		<div class="col-sm-9">
			...
			<p class="small text-muted">
				<?php echo /* I18N: Help text for the "Data folder" site configuration setting */ I18N::translate('This folder will be used by nexu to store media files, GEDCOM files, temporary files, etc.  These files may contain private data, and should not be made available over the internet.'); ?>
			</p>
			<p class="small text-muted">
				<?php echo /* I18N: “Apache” is a software program. */ I18N::translate('To protect this private data, nexu uses an Apache configuration file (.htaccess) which blocks all access to this folder.  If your web-server does not support .htaccess files, and you cannot restrict access to this folder, then you can select another folder, away from your web documents.'); ?>
			</p>
			<p class="small text-muted">
			...
			<p class="small text-muted">
				<?php echo I18N::translate('The folder can be specified in full (e.g. /home/user_name/nexu_data/) or relative to the installation folder (e.g. ../../nexu_data/).'); ?>
			</p>
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-sm-9">
			...
			<p class="small text-muted">
				<?php echo /* I18N: Help text for the "Default theme" site configuration setting */ I18N::translate('You can change the appearance of nexu using “themes”.  Each theme has a different style, layout, color scheme, etc.'); ?>
			</p>
			<p class="small text-muted">
	...
	<div class="form-group">
		...
		<div class="col-sm-9">
			...
			<p class="small text-muted">
				<?php echo /* I18N: Help text for the “Session timeout” site configuration setting */ I18N::translate('The time in seconds that a nexu session remains active before requiring a login.  The default is 7200, which is 2 hours.'); ?>
				<?php echo I18N::translate('If you leave this setting empty, the default value will be used.'); ?>
			</p>
		</div>
	</div>
...
<?php elseif (Filter::get('action') === 'email'): ?>
	...
	<input type="hidden" name="action" value="tracking">
		...
		<p>
			<?php echo I18N::translate('If you use one of the following tracking and analytics services, nexu can add the tracking codes automatically.'); ?>
		</p>
		...
		<div class="form-group">
			...
			<div class="col-sm-9">
				<input
					...
					>
				<p class="small text-muted">
					<?php echo /* I18N: Help text for the "Site verification code for Google Webmaster Tools" site configuration setting */ I18N::translate('Site verification codes do not work when nexu is installed in a subfolder.'); ?>
				</p>
			</div>
		</div>
